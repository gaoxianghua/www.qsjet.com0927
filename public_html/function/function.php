...
function getSoonClass_tr($id,$spacestr){
	...
	if($fun_nums > 0){
		while($fun_rs = mysql_fetch_array($fun_rows)){
			...
			echo "<td align=\"center\"><input name=\"bigclass_pic\" type=\"text\" id=\"bigclass_pic\" class=\"bigclass_pic".$fun_rs['id']."\" value=\"".$fun_rs['bigclass_pic']."\" size=\"12\" /><input name=\"".$fun_rs['id']."\" type=\"button\" class=\"image1\" value=\"上传\" /></td>";
...
$fun_rs=mysql_fetch_array($fun_rows);
	...
	$index_counter = $fun_rs['index_counter'];
?>