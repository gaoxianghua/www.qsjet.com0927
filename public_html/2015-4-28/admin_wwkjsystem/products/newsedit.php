...
<table width="97%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#333333">
  <form id="myform" name="myform" method="post" action="newsaddsave.php?action=edit">
    ...
    <tr>
      ...
      <td bgcolor="#EFEFEF"><input name="news_xinghao" type="text" id="news_xinghao" value="<?=$news_xinghao?>" size="40" /></td>
...
<input name="re_url" type="hidden" id="re_url" value="<?=$_SERVER['HTTP_REFERER']?>" /></td>
    ...
    <tr>
      ...
      <td colspan="5" bgcolor="#EFEFEF"><input name="news_price" type="text" id="news_price" value="<?=$news_price?>" size="10" />
      元</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="5" bgcolor="#EFEFEF"><textarea name="news_text" cols="70" rows="3" id="news_text"><?=$news_text?></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right" bgcolor="#EFEFEF">产品参数：</td>
