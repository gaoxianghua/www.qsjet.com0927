...
<table width="97%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#333333">
  <form id="myform" name="myform" method="post" action="">
    ...
    <tr>
      ...
      <td width="370" bgcolor="#EFEFEF"><input name="addres" type="text" id="news_title" size="50" />
    <tr>
      <td align="right" bgcolor="#EFEFEF">城市名称：</td>
      <td colspan="5" bgcolor="#EFEFEF"><input name="city_name" type="text" id="news_pic" value="" size="25" />
...
function lng_lat($url)
{
	...
	if($_POST['Submit'])
	{
		...
		$url="http://api.map.baidu.com/geocoder?address={$addres}&output=json&key=";
		$lng_lat_arr=lng_lat($url);
		
		$lng=$lng_lat_arr['lng'];//经度
		$lat=$lng_lat_arr['lat'];//伟度
		...
		$true=insertDB_id_zj($tab,$insertValue);
