<?php
	...
	if($action == "add"){
		...
		(news_language,news_title,news_color,news_style,news_from,news_writer,news_keywords,news_desc,news_bigclass,news_pic,news_tourls,news_text,news_content,news_hit)
		values
		($news_language,'$news_title','$news_color','$news_style','$news_from','$news_writer','$news_keywords','$news_desc',$news_bigclass,'$news_pic','$news_tourls','$news_text','$news_content',$news_hit)
		";
