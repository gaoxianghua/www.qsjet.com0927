<?php
	...
	$edit_sql = "select * from kboy_piclink where id=$id";
...
<table width="97%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td><strong>后台管理</strong>&nbsp;-&nbsp;<span class="hong"><strong>广告修改</strong></span></td>
  </tr>
...
<table width="97%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#333333">
  <form id="myform" name="myform" method="post" action="newsaddsave.php?action=edit">
    <tr>
      <td width="80" align="right" bgcolor="#EFEFEF">版本选择：</td>
      <td bgcolor="#EFEFEF">
    ...
    <tr>
      <td align="right" bgcolor="#EFEFEF">广告标题：</td>
    ...
    <tr>
      ...
      <td bgcolor="#EFEFEF"><input name="news_text" type="text" id="news_text" value="<?=$news_text?>" size="50" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#EFEFEF"><input name="news_pic" type="text" id="news_pic" value="<?=$news_pic?>" size="25" />
          <input name="button" type="button" id="image1" value="选择图片" /></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#EFEFEF">链接地址：</td>
      <td bgcolor="#EFEFEF"><input name="news_tourls" type="text" id="news_tourls" value="<?=$news_tourls?>" size="50" /></td>
    </tr>
    <tr>
