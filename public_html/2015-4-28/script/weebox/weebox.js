		...
		this.initBox = function() {
			...
			switch(self.options.type) {
				...
				html =  '<div class="weedialog">' +
						...
						break;
				case 'loading':
					html = '<div style="background-color: #BADCFF;width: 216px;border: 1px solid #7996B8;"><div style="background-color: #FFFFFF;margin: 2px;width: 212px;height:65px;text-align: center;font-size: 14px;font-weight: bold;color: #FF0000;padding-top: 10px;background-image: url(img/loading.gif);background-repeat: no-repeat;background-position: center bottom;">'
