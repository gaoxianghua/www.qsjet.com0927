<?php
	...
	if($nums>0){
		...
		$index_mk6 = $rs['index_mk6'];
		$index_counter = stripslashes($rs['index_counter']);
	}else{
	...
	if($action == "edit"){
		...
		$index_mk6 = $_REQUEST['index_mk6'];
		$index_counter = addslashes($_REQUEST['index_counter']);
		mysql_query("update kboy_webinfo set index_copy='$index_copy',index_mk1='$index_mk1',index_mk2='$index_mk2',index_mk3='$index_mk3',index_mk4='$index_mk4',index_mk5='$index_mk5',index_mk6='$index_mk6',index_counter='$index_counter',web_titles='$web_titles',web_keywords='$web_keywords',web_description='$web_description'");
...
<form id="myform" name="myform" method="post" action="webinfo.php?action=edit">
    ...
    <tr>
      <td align="center" bgcolor="#EFEFEF">首页视频地址：</td>
      <td bgcolor="#EFEFEF"><input name="index_mk6" type="text" id="index_mk6" value="<?=$index_mk6?>" size="70" />
        仅限FLV视频</td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="center" bgcolor="#EFEFEF">计数器代码：</td>
      <td bgcolor="#EFEFEF"><textarea name="index_counter" cols="100" rows="6" id="index_counter"><?=$index_counter?></textarea></td>
    </tr>
    <tr>
