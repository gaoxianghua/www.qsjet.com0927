...
<table width="97%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td><strong>后台管理</strong>&nbsp;-&nbsp;<span class="hong"><strong>留言管理</strong></span></td>
  </tr>
</table>
...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#000000">
  <tr bgcolor="#336699">
    ...
    <td align="center"><span class="bai12">标题</span></td>
    <td align="center"><span class="bai12">姓名</span></td>
    <td align="center"><span class="bai12">电话</span></td>
    <td align="center"><span class="bai12">邮箱</span></td>
    <td align="center"><span class="bai12">地址</span></td>
    <td align="center"><span class="bai12">留言内容</span></td>
    <td align="center"><span class="bai12">是否回复</span></td>
    <td align="center"><span class="bai12">查询日期</span></td>
    <td width="100" align="center"><span class="bai12">操作</span></td>
  </tr>
  <?php
		$sql="";
		...
		if($keys != ""){
			if($sql != ""){
				$sql = $sql." and m_title like '%".$keys."%'";
			}else{
				$sql = " m_title like '%".$keys."%'";
			}
		}
...
if($sql != ""){
	$numsql="select * from kboy_liuyan where ".$sql." order by id desc";
}else{
	$numsql="select * from kboy_liuyan";
}
...
if($sql!=""){
$sql="select * from kboy_liuyan where ".$sql." order by id desc limit $page $pagesize";
}else{
$sql="select * from kboy_liuyan order by id desc limit $page $pagesize";
}
...
?>
  <form action="newsaddsave.php?action=del" method="post" name="myform" id="myform">
    <tr bgcolor="#efefef" onmouseover="this.style.background='#C9C9C9'" onmouseout="this.style.background='#efefef'">
      ...
      <td align="center"><?=$rs['m_title']?></td>
      <td align="center"><?=$rs['m_name']?></td>
      <td align="center"><?=$rs['m_tel']?></td>
      <td align="center"><?=$rs['m_email']?></td>
      <td align="center"><?=$rs['m_address']?></td>
      <td align="center"><?=$rs['m_content']?></td>
      <td align="center"><?php
	  ...
	  ?></td>
      <td align="center"><?= $rs['m_addtime']?></td>
      <td align="center"><a href="newsedit.php?id=<?=$rs['id']?>">回复</a></td>
    </tr>
	<?php
	}if($num>0){
	?>
