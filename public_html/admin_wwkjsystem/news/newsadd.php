...
<table width="97%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td><strong>后台管理</strong>&nbsp;-&nbsp;<span class="hong"><strong>文章添加</strong></span></td>
  </tr>
...
<table width="97%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#333333">
  <form id="myform" name="myform" method="post" action="newsaddsave.php?action=add">
    ...
    <tr>
      ...
      <td colspan="5" bgcolor="#EFEFEF"><input readonly="" name="news_addtime" type="text" id="news_addtime" value="<?=date('Y-m-d H:m:s',time())?>" size="25" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" /></td>
    </tr>
    <tr>
