...
<table width="97%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#333333">
  <form id="myform" name="myform" method="post" action="newsaddsave.php?action=add">
    ...
    <tr>
      ...
      <td colspan="5" bgcolor="#EFEFEF"><input name="news_xilie" type="text" id="news_xilie" size="25" /></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#EFEFEF">颜色：</td>
      <td colspan="5" bgcolor="#EFEFEF"><input name="news_yanse" type="text" id="news_yanse" size="25" />
        <span class="hong">多种颜色请用英文逗号（,）分隔</span></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#EFEFEF">适应人员：</td>
      <td colspan="5" bgcolor="#EFEFEF"><input name="news_renyuan" type="text" id="news_renyuan" size="25" /></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#EFEFEF">适应领域：</td>
      <td colspan="5" bgcolor="#EFEFEF"><input name="news_lingyu" type="text" id="news_lingyu" size="25" /></td>
    </tr>
    ...
    <tr>
      <td align="right" bgcolor="#EFEFEF">上传图片：</td>
      <td colspan="5" bgcolor="#EFEFEF"><input name="news_pic2" type="text" id="news_pic2" size="25" />
          <input name="button" type="button" id="image2" value="选择图片" />
          <span class="hong">图片比例3:4</span></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#EFEFEF">上传图片：</td>
      <td colspan="5" bgcolor="#EFEFEF"><input name="news_pic3" type="text" id="news_pic3" size="25" />
          <input name="button" type="button" id="image3" value="选择图片" />
          <span class="hong">图片比例3:4</span></td>
    </tr>
    <tr>
      <td align="right" bgcolor="#EFEFEF">上传图片：</td>
      <td colspan="5" bgcolor="#EFEFEF"><input name="news_pic4" type="text" id="news_pic4" size="25" />
    ...
    <tr>
      ...
      <td colspan="5" bgcolor="#EFEFEF"><textarea name="news_content3" style="width:680px;height:350px;visibility:hidden;"></textarea></td>
    </tr>
    <tr>
