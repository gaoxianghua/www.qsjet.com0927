...
insert into `kboy_bigclass`(`id`,`pid`,`bigclass_cn`,`bigclass_en`,`bigclass_order`,`bigclass_pic`,`bigclass_urls`,`bigclass_menu`,`bigclass_style`) values('127','63','新闻中心','','127','','news.php?classid=99','0','3');
