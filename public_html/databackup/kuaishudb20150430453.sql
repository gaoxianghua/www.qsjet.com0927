...
insert into `kboy_news`(`id`,`news_language`,`news_title`,`news_color`,`news_style`,`news_from`,`news_writer`,`news_keywords`,`news_desc`,`news_bigclass`,`news_pic`,`news_pic2`,`news_tourls`,`news_hit`,`news_content`,`news_order`,`news_top`,`news_text`,`news_addtime`) values('23','1','QS-H型无针注射器','','','北京快舒尔医疗技术有限公司','Admin','','','75','/UploadFile/image/20150331/20150331095938_96385.jpg','','','8','<p>
	&nbsp;
</p>','23','','特点：连续高效注射
