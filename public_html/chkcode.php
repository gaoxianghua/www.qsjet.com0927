<?php
	...
	if($action = "chk"){
		...
		$client_result = $result->reply;
		 ...
		 $m_sql = "update kboy_message set client_result='$client_result',client_fcode='$client_fcode' where client_name='$client_name' and client_phone='$client_phone' and client_pronum='$client_pronum'";
